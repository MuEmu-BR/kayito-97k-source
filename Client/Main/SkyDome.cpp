...
{
	float x_char = *(float*)(MAIN_VIEWPORT_STRUCT + 0x10);
	float y_char = *(float*)(MAIN_VIEWPORT_STRUCT + 0x14);
	float z_char = *(float*)(MAIN_VIEWPORT_STRUCT + 0x12C) + *(float*)(MAIN_VIEWPORT_STRUCT + 0x18) - 200.0f;
